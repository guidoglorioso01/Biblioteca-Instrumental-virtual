...
class Mediciones():
    ...
    """   
        ...
        ###########################################################################
        tension_gen = tension_gen - self.Vmed(tension_gen)
        tension_r = tension_r - self.Vmed(tension_r)
        ...
        ###########################################################################
        zeros_mid_list, limits_ciclos = separar_ciclos(tension_gen)
    ...
    """   
        ...
        zeros_mid_list_gen, limits_ciclos_gen = separar_ciclos(tension_gen)
        zeros_mid_list_r, limits_ciclos_r = separar_ciclos(tension_r)
